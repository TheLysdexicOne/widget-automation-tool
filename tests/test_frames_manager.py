...
class TestFramesManager:
    ...
    def test_add_frame(self, frames_manager):
        """Test adding a frame"""
        frame_data = {"name": "test_frame", "item": "test_item", "automation": 1, "text": [], "screenshots": []}
    ...
    def test_get_frame_list_with_data(self, frames_manager):
        ...
        mock_data = {"test_frame": {"name": "test_frame", "item": "test_item", "automation": 1}}
        with patch.object(frames_manager, "_load_frames_database", return_value=mock_data):
            result = frames_manager.get_frame_list()
            assert len(result) == 1
    ...
    def test_update_frame(self, frames_manager):
        ...
        original_data = {"test_frame": {"name": "test_frame", "item": "old_item"}}
        updated_frame_data = {"name": "test_frame", "item": "new_item"}
    ...
    def test_delete_frame_placeholder(self, frames_manager):
        """Test delete frame functionality - placeholder since method doesn't exist"""
        # This test acknowledges that delete_frame doesn't exist yet
        assert not hasattr(frames_manager, "delete_frame")
        # If/when implemented, this would test actual deletion
