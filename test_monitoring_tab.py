...
def test_playable_area_detection():
    ...
    try:
        ...
        if playable_rect:
            ...
            print(
                f"  Aspect ratio: {playable_rect['width']/playable_rect['height']:.3f}"
            )
            ...
            if hasattr(tab, "get_background_coordinates"):
                ...
                if bg_coords:
                    ...
                    print(
                        f"  Grid size: {bg_coords['grid_width']}x{bg_coords['grid_height']}"
                    )
                    print(
                        f"  Pixel size: {bg_coords['pixel_width']}x{bg_coords['pixel_height']}"
                    )
                else:
